...
@onready var coliders = [$Armature/Skeleton3D/head/RayCast3D, $Armature/Skeleton3D/head/RayCast3D2, $Armature/Skeleton3D/head/RayCast3D3, $Armature/Skeleton3D/head/RayCast3D4, $Armature/Skeleton3D/head/RayCast3D5, $Armature/Skeleton3D/head/RayCast3D6, $Armature/Skeleton3D/head/RayCast3D7, $Armature/Skeleton3D/head/RayCast3D8, $Armature/Skeleton3D/head/RayCast3D9, $Armature/Skeleton3D/head/RayCast3D10, $Armature/Skeleton3D/head/RayCast3D11, $Armature/Skeleton3D/head/RayCast3D12, $Armature/Skeleton3D/head/RayCast3D13, $Armature/Skeleton3D/head/RayCast3D14, $Armature/Skeleton3D/head/RayCast3D15, $Armature/Skeleton3D/head/RayCast3D16, $Armature/Skeleton3D/head/RayCast3D17, $Armature/Skeleton3D/head/RayCast3D18, $Armature/Skeleton3D/head/RayCast3D19, $Armature/Skeleton3D/head/RayCast3D20, $Armature/Skeleton3D/head/RayCast3D21]
...
func player_nav_point_body_entered(_body):
	if _body.is_in_group("SEC_BOT"):
		if !notifications:
			...
			the_path_is_set = true
			if !notifications:
				purpose.global_position = $"../../../navigation/nav_the_other_ramka".global_position
